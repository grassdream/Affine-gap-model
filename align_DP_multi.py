...
def write_output_score(outfile, max_score):
    with open(outfile, 'w') as out_f:
        out_f.write("score = %d\n" % max_score)

def write_output(outfile, seq1, seq2, i):
...
write_output_score(out_file, max_score)
for i in range(len(align1)):
    write_output(out_file, align1[i], align2[i],i+1)
